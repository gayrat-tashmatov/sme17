...
export function A_Communications() {
  ...
  return (
    <>
      <ModuleHero
        letter="а"
        title="B2B и B2G коммуникация"
        subtitle="Единое пространство: B2B через Cooperation.uz, отраслевые сообщества, подбор партнёров и обращения в ведомства через E-Ijro."
        phase="Фаза 1 · до 01.07.2026"
      />
